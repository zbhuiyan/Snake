...
public class Clock {
  ...
  public void updateClock(){
    ...
    // the current time.
    float delta = (float)(getCurrentTime() - lastClockUpdate); 
  ...
  public boolean hasPassedCycle(){
    if(numPassedCycles > 0){
      this.numPassedCycles = 0; //If the number of passed cycles is greater than 0, it will decrement  
      return true;
    }
    else {
      return false;
